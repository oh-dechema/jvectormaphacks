var plants = [
    {name: 'DECHEMA Gesellschaft für Chemische Technik und Biotechnologie e.V.', contact: 'Herr Dr.-Ing. Alexis Bazzanella', coords: [50.113176, 8.644545], coordinator: 'CO<sub>2</sub>Net+', partner: ['CO<sub>2</sub>Net+']},
    {name: 'Universität Kassel - Center for Environmental Systems Research', contact: 'Herr Prof. Dr. Stefan Bringezu', coords: [51.322753, 9.507594], partner: ['CO<sub>2</sub>Net+']},
    {name: 'Institute for Advanced Sustainability Studies e.V.', contact: 'Frau Dr. Barbara Olfe-Kräutlein', coords: [52.406065, 13.073215], partner: ['CO<sub>2</sub>Net+']},
	...
	{name: 'DBI Gas- und Umwelttechnik GmbH', contact: 'Herr Dipl.Chem. Udo Lubenau', coords: [51.328806, 12.324799], coordinator: 'CO<sub>2</sub>-Selekt', partner: ['CO<sub>2</sub>-Selekt']},
	{name: 'Fraunhofer-Institut für Keramische Technologien und Systeme - Institutsteil Hermsdorf', contact: 'Herr Dr. Norman Reger-Wagner', coords: [50.895050, 11.845542], partner: ['CO<sub>2</sub>-Selekt']},
	{name: 'Walhalla Kalk GmbH & Co. KG', contact: 'Herr Wolfgang Scheurer', coords: [49.03033,12.1348713], partner: ['CO<sub>2</sub>-Selekt']},
	{name: 'Wünschendorfer Dolomitwerk GmbH', contact: 'Herr Olaf Ortlepp', coords: [50.8031346,12.0897214], partner: ['CO<sub>2</sub>-Selekt']},
	{name: 'BGH Edelstahl Freital GmbH', contact: 'Herr Sönke Winterhager', coords: [50.9941311,13.6387161], partner: ['CO<sub>2</sub>-Selekt']},
	{name: 'Johann Bergmann GmbH & Co', contact: 'Herr Dr. Thomas Jendersie', coords: [50.027220, 11.308620], partner: ['CO<sub>2</sub>-Selekt']},
	...
	{name: 'BASF SE, RCS/OH, M313', contact: 'Herr Dr. Thomas Schaub', coords: [49.4956015,8.4305842], coordinator: 'CO<sub>2</sub>Form', partner: ['CO<sub>2</sub>Form']},
	{name: 'Ruprecht-Karls-Universität Heidelberg - Anorganisch-Chemisches Institut', contact: 'Herr Prof. Dr. Peter Comba', coords: [49.4168806,8.6702987], partner: ['CO<sub>2</sub>Form']},
	{name: 'Ludwig-Maximilians-Universität München - Department Chemie und Biochemie - Bereich Organische Chemie', contact: 'Herr Prof. Dr. Oliver Trapp', coords: [48.150806,11.5782413], partner: ['CO<sub>2</sub>Form']},
	{name: 'hte GmbH', contact: 'Herr Dr. Andreas Kuschel', coords: [49.407192,8.6375833], partner: ['CO<sub>2</sub>Form']},
	{name: 'Klüber Lubrication München SE & Co. KG', contact: 'Dr. Stefan Grundei', coords: [48.0975029,11.517738], coordinator: 'CO<sub>2</sub>Lubricants', partner: ['CO<sub>2</sub>Lubricants']},
	{name: 'AUDI Aktiengesellschaft - I/EG-X1 - Nachhaltige Produktkonzepte / Werkstoffe / Recycling', contact: 'Frau Dr. Simone Müller-Hellwig', coords: [48.7829781,11.4116014], partner: ['CO<sub>2</sub>Lubricants']},
	{name: 'Subitec GmbH', contact: 'Herr Peter Bergmann', coords: [48.73811,9.1651213], partner: ['CO<sub>2</sub>Lubricants']},
	{name: 'Technische Universität München - Werner Siemens–Lehrstuhl für Synthetische Biotechnologie', contact: 'Herr Prof. Dr. Thomas Brück', coords: [48.2684505,11.6668315], partner: ['CO<sub>2</sub>Lubricants']},
	...
	partnerMap = $('#map').vectorMap({
		...
		series: {
		  markers: [
			...
			scale: {
				'CO<sub>2</sub>Net+': colors[0],
				
				'CORAL': colors[1],
				'CO<sub>2</sub>-Selekt': colors[2],
				'TherMemPlus': colors[3],
				
				'Dream Resource': colors[4],
				'CO<sub>2</sub>Form': colors[5],
				'CO<sub>2</sub>Lubricants': colors[6],
				'OptiMeOH': colors[7],
